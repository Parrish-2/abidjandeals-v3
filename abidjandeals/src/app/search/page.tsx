...
// e.g. slugify('Téléphones & Accessoires') â†’ 'telephones-accessoires' â†’ 'Téléphones & Accessoires'
...
const LABELS: Record<string, string> = {
  ...
  "hightech-informatique": "High-Tech & Informatique", "vehicules-equipements": "VÉhicules & À‰quipements",
  ...
  "camions-utilitaires": "Camions & Utilitaires", "groupes-electrogenes": "Groupes À‰lectrogÈnes",
  "materiel-agricole": "MatÉriel Agricole", "outillage-industriel": "Outillage Industriel",
  "engins-chantier": "À‰quipements de Chantier", "smartphones": "Smartphones",
  ...
  "bureaux-boutiques": "Bureaux & Commerces", "vetements": "VÀªtements & Chaussures",
  ...
  "evenementiel": "À‰vÉnementiel", "equipements-sport": "À‰quipements de Sport",
...
function SearchContentV2() {
  ...
  const etats = ["Neuf", "Comme neuf", "Bon État", "À‰tat correct", "Disponible"]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
          ...
          <div className="border-t border-gray-100 bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 md:px-8 py-4">
              <div className="flex flex-wrap gap-4 items-end">
                ...
                <div>
                  <label className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5 block">À‰tat</label>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 md:px-8">
        ...
        {!ageCleared ? (
          <div className="flex flex-col items-center justify-center py-32 text-center"><span className="text-6xl mb-4">ðŸ”ž</span><p className="text-gray-400 text-sm">VÉrification de l'À¢ge en cours...</p></div>
        ) : loading ? (
