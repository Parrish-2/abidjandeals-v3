...
import BannerSlot from '@/components/BannerSlot'; // ← AJOUT
        ...
        <div className="min-h-screen flex flex-col bg-gray-50">
            ...
            <main className="flex-1">
                ...
                <div className="max-w-7xl mx-auto px-4 pt-6 pb-10 space-y-6">
                    ...
                    {/* ── BANNIÈRE 1 : homepage_top (970×90px) ── */}
                    <BannerSlot position="homepage_top" />

                    {/* ── BANNIÈRE 2 : homepage_mid (970×250px) ── */}
                    <BannerSlot position="homepage_mid" />
