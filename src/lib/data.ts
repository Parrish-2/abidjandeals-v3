...
const newContent = `export const CATEGORIES = [
  {
    id: 'cat_tech',
    name: 'High-Tech',
    icon: '\u{1F4F1}',
    color: '#6366f1',
    subcats: ['\u{1F4F1} T\u00e9l\u00e9phones & Tablettes', 'Ordinateurs & Laptops', 'TV & Home Cin\u00e9ma', 'Consoles & Jeux Vid\u00e9o', 'Photo & Vid\u00e9o', 'Objets Connect\u00e9s', 'Imprimantes & Scanners', 'Composants (RAM, SSD...)'],
  },
  {
    id: 'cat_auto',
    name: 'Automobile',
...
fs.writeFileSync('src/lib/data.ts', newContent, { encoding: 'utf8' });
