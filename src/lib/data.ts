export const CATEGORIES = [
  ...
  // ✅ NOUVELLE CATÉGORIE — Lingerie & Accessoires (adultes 18+)
  {
    id: 'lingerie',
    name: 'Lingerie & Accessoires',
    icon: '👙',
    color: '#f43f5e',
    isAdult: true, // 🔞 Flag adulte — déclenche l'age gate
    subcats: [
...
export const MOCK_ADS = [
  ...
  { id: 9, title: 'Réfrigérateur LG 350L NoFrost', price: 420000, category: 'electromenager', subcategory: 'Réfrigérateurs', city: 'Abidjan', quartier: 'Treichville', etat: 'Neuf', seller: 'Electro Discount', certified: false, views: 198, badge: 'new', img: 'https://images.unsplash.com/photo-1571175443880-49e1d25b2bc5?w=400&h=300&fit=crop', emoji: '🧊' },
  { id: 10, title: 'Terrain 500m² Bingerville', price: 12000000, category: 'immobilier', subcategory: 'Terrains', city: 'Abidjan', quartier: 'Bingerville', etat: 'Disponible', seller: 'FonciCI', certified: true, views: 445, badge: null, img: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=400&h=300&fit=crop', emoji: '🌿' },
  { id: 11, title: 'PS5 + 3 jeux', price: 480000, category: 'hightech', subcategory: 'Jeux vidéo', city: 'Abidjan', quartier: 'Cocody', etat: 'Bon état', seller: 'GameZone CI', certified: false, views: 523, badge: 'boost', img: 'https://images.unsplash.com/photo-1606813907291-d86efa9b94db?w=400&h=300&fit=crop', emoji: '🎮' },
  { id: 12, title: 'Location minibus 30 places', price: 80000, category: 'location', subcategory: 'Location bus & minibus', city: 'Bouaké', quartier: 'Commerce', etat: 'Disponible', seller: 'TransportCI', certified: true, views: 134, badge: null, img: 'https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?w=400&h=300&fit=crop', emoji: '🚌' },
]
